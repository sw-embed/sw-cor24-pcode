...
struct Vm {
    ...
    // Status
    status: u8, // 0=running, 1=halted, 2=trapped
    trap_code: u8,
...
const CALL_STACK_WORDS: usize = 256;
const EVAL_STACK_WORDS: usize = 256;
...
impl Vm {
    ...
    fn trace_instruction(&self, pc: usize, op: Opcode) {
